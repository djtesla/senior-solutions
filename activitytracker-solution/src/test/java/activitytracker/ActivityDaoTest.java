...
class ActivityDaoTest {
    ...
    void testFindTrackPointCountByActivity(){
        ...
        Activity activity2 = new Activity(LocalDateTime.of(2021, 8, 22, 15, 33),
                "Túrázás a Bükkben", Activity.ActivityType.HIKING, List.of("Rossz idő volt", "Sok kaját vittünk"));
        Activity activity3 = new Activity(LocalDateTime.of(2021, 8, 22, 15, 33),
                "Túrázás a Mátrában", Activity.ActivityType.HIKING, List.of("Kellemes idő volt", "Sok piát vittünk"));
        activityDao.saveActivity(activity1);
        activityDao.saveActivity(activity2);
        activityDao.saveActivity(activity3);
        long id1 = activity1.getId();
        long id2 = activity2.getId();
        long id3 = activity3.getId();
        TrackPoint trackPoint1 = new TrackPoint(LocalDate.of(2021, 3, 22), 103, 100);
        TrackPoint trackPoint2 = new TrackPoint(LocalDate.of(2021, 8, 23), 108, 105);
        TrackPoint trackPoint3 = new TrackPoint(LocalDate.of(2021, 2, 23), 102, 105);
        TrackPoint trackPoint4 = new TrackPoint(LocalDate.of(2021, 10, 23), 110, 105);
        TrackPoint trackPoint5 = new TrackPoint(LocalDate.of(2021, 10, 23), 110, 105);
        TrackPoint trackPoint6 = new TrackPoint(LocalDate.of(2021, 10, 23), 110, 105);
        TrackPoint trackPoint7 = new TrackPoint(LocalDate.of(2021, 10, 23), 110, 105);
        activityDao.addTrackPoint(id1, trackPoint1);
        activityDao.addTrackPoint(id1, trackPoint2);
        activityDao.addTrackPoint(id2, trackPoint3);
        activityDao.addTrackPoint(id2, trackPoint4);
        activityDao.addTrackPoint(id3, trackPoint5);
        activityDao.addTrackPoint(id3, trackPoint6);
        activityDao.addTrackPoint(id3, trackPoint7);

        List<Object[]> trackPointsByActivity = activityDao.findTrackPointCountByActivity();
        assertEquals("[Túrázás a Mátrában, 5]", Arrays.toString(trackPointsByActivity.get(1)));
    }
